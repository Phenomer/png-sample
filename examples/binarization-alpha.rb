...
png_dst = PNGWriter.new(width: 1000, height: 1000, color: :ga8)
...
0.upto(999) do |y|
  0.upto(999) do |x|
    ...
    # R・G・Bを足し合わせて3で割った値が127以上であれば255、それ以外は0
    if pixel[0..2].sum / 3 > 127
      grayscale = 255
    else
      grayscale = 0
    end
...
png_dst.write('export_binarization-alpha.png')
